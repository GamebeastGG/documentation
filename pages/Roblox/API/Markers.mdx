...
<ReturnType type="RBXScriptConnection"/>
This method fires a callback with a raw list of markers that failed to send to Gamebeast.

<ParameterList>
    <Parameter name="callback" type="(failedMarkers : {{[string] : any}}) -> ()">
...
GamebeastMarkers:RetryFailedMarkers(FailedMarkersFromDatastore)
```