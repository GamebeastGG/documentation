...
No special programming is required to use the A/B testing values, simply reference the configuration with the `Get` method and
create a listener via the `OnChanged` method to handle updates as needed.

## Terminate an A/B testing campaign
