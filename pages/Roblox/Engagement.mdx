...
Only custom markers you define through the SDK will count towards your marker quota. Gamebeast automatically sends a number of built-in markers to track generic player interactions, such as player joins, leaves, and chats, but **these do not count towards your quota**.
