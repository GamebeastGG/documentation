...
Using configuration is simple. Use the [`Get`](https://docs.gamebeast.gg/Roblox/SDK%20Functions/Get) method to reference a
configuration and the [`OnChanged`](https://docs.gamebeast.gg/Roblox/SDK%20Functions/OnChanged) method to listen for and handle
updates.