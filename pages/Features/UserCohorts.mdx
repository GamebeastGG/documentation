...
Cohorts can be used directly in your queries through the [Query Builder](/Features/QueryBuilder) as a **Breakdown, Local filter, and/or Global filter**.
...
From here, you can edit the cohort name and groups. You can also delete the cohort by clicking the "Delete Cohort" button in the bottom right.