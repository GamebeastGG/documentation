...
Similarly to [how you can make other visualizations in the Query Builder](/Features/QueryBuilder), funnels are created through the Gamebeast dashboard.
...
Funnels are built using a series of steps, where each step represents a marker that players must pass through to continue down the funnel. You can add as many steps as you like, and each step can be configured with its own [local filters](/Features/QueryBuilder).
