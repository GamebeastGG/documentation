...
Similarly to [how you can make other visualizations in the Query Builder](/Features/QueryBuilder), retention queries are created through the Gamebeast dashboard.
...
Steps can be configured with [local filters](/Features/QueryBuilder) to filter the data by specific properties, arguments, or experiments.
...
Similarly to the other query types, retention queries also support [Global filters](/Features/QueryBuilder#global-filters) and [breakdowns](/Features/QueryBuilder#breakdowns) to filter your data by specific properties, arguments, or experiments.
