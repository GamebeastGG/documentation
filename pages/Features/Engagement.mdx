...
To send markers to Gamebeast, you must first fetch the [`Markers`](/Features/API/Markers) service from the Gamebeast SDK. You can then use the provided `:SendMarker` methods to send markers to Gamebeast with your custom data.
